...
<p align="center">
  <img src="https://skillicons.dev/icons?i=react,vite,tailwind,ts,js,django,python,express,nodejs,java,spring,docker,git,linux,html,css,cpp,arduino,bash,mysql,postgres,haskell,github,raspberrypi" />
</p>
